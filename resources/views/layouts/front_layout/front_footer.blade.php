            ...
            <div class="row justify-content-lg-between">
                    ...
                    <div class="footer_about" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="footer_useful_links mb_30">
                            <ul class="ul_li_block clearfix">
                                <li><a href="#!"><i class="fal fa-angle-right"></i> More Information</a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-sm-12">
                    <div class="footer_contact_info" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <ul class="ul_li_block clearfix">
                            ...
                            <li><i class="fas fa-envelope"></i> <strong>mfuko@gmail.com</strong></li>
                            <li><i class="fas fa-phone"></i> <strong>+237677684277</strong></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-sm-12">
                    <div class="footer_useful_links" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <ul class="ul_li_block clearfix">
                            <li><a href="#!"><i class="fal fa-angle-right"></i> Safely send and receive a package</a></li>
                            <li><a href="#!"><i class="fal fa-angle-right"></i> Offers</a></li>
                            <li><a href="#!"><i class="fal fa-angle-right"></i> F.A.Q.</a></li>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <p class="copyright_text mb-0">Copyright © 2021. mfuko by <a class="author_links text-white" href="www.vistechy.com">Visual Technology</a></p>
                </div>
