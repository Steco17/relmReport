...
<main>
    ...
    <section class="breadcrumb_section text-center clearfix">
        <div class="page_title_area has_overlay d-flex align-items-center clearfix" data-bg-image="{{url('images/front_images/breadcrumb/bg_06.jpg') }}">
    ...
    <div class="google_map_section clearfix" data-aos="fade-up" data-aos-delay="100">
        <div id="mapBox" data-lat="4.04827" data-lon="9.70428" data-zoom="13" data-info="MFOKU, Douala, Cameroon" data-mlat="4.04827" data-mlon="9.70428">
        </div>
    </div>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                        <div class="image_area">
                            <div class="brand_logo mb_15">
                                <a href="index.html">
                                    <img src="{{url('images/front_images/logo/logo_01_1x.png') }}" srcset="{{url('images/front_images/logo/logo_01_2x.png') }} 2x" alt="logo_not_found">
                                </a>
                            </div>
                            <p class="mb_30">
                            ...
                            <div class="image_wrap">
                                <img src="{{url('images/front_images/about/img_02.jpg') }}" alt="image_not_found">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="content_area">
                            ...
                            <ul class="ul_li_block mb_30 clearfix">
                                ...
                                <li><i class="fas fa-phone"></i> +237677684277</li>
                                <li><i class="fas fa-envelope"></i> mfokusupport@gmail.com</li>
                            </ul>
                            <form action="#">
        ...
        <div class="container">
            ...
            <form id="contact_form" action="mail.php" method="POST">
                ...
                <div class="abtn_wrap text-center clearfix" data-aos="fade-up" data-aos-delay="600">
                    <button type="submit" value="submit" class="custom_btn btn_width bg_default_red text-uppercase">Send a Message <img src="{{url('images/front_images/icons/icon_01.png') }}" alt="icon_not_found"></button>
                </div>
            </form>
